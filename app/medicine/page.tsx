...
//               <div className="grid grid-cols-2 gap-x-6 gap-y-10 lg:grid-cols-4 xl:grid-cols-4">
                ...
                {hasMore && (
                  <div className="mt-12 flex justify-center">
                    <button
                      ...
                      className="rounded-full bg-black px-8 py-3 text-sm font-medium text-white transition-all hover:bg-gray-800 active:scale-95"
                    >
